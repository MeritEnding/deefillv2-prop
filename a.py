...
def brush_stroke_mask(FLAGS, name='mask'):
    ...
    def generate_mask(H, W):
        ...
        """
        if 200 < check_step and check_step < 280:
            ...
            return mask
        elif(280<=check_step and check_step<290):
            """
              바운딩 박스로부터 브러시 스트로크 마스크를 생성합니다.
            ...
            mask = np.reshape(mask, (1, H, W, 1))  # 마스크의 형상을 수정합니다.
            return mask
        elif(290<= check_step and check_step<300):
            """
                    바운딩 박스로부터 브러시 스트로크 마스크를 생성합니다.
            ...
            mask = np.reshape(mask, (1, H, W, 1))  # 마스크의 형상을 수정합니다.
            return mask
        elif(300<= check_step and check_step<310):
            """
               바운딩 박스로부터 브러시 스트로크 마스크를 생성합니다.
